        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <a href="governance.php" class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg">Governance</a>
            ...
            <div id="mobileMenu" class="hidden md:hidden pb-4 space-y-2">
                ...
                <a href="mentor_messages.php" class="block py-2 px-4 text-gray-600 hover:bg-gray-100 rounded-lg">Inbox <?= $unreadMessages > 0 ? '('.$unreadMessages.')' : '' ?></a>
                <a href="team_leaderboard.php" class="block py-2 px-4 text-gray-600 hover:bg-gray-100 rounded-lg">Teams</a>
