        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="mentor_dashboard.php" class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg">Dashboard</a>
                    <a href="mentor_messages.php" class="px-4 py-2 bg-purple-100 text-purple-700 rounded-lg font-medium">Inbox</a>
                    <a href="team_leaderboard.php" class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg">Teams</a>
            ...
            <div id="mobileMenu" class="hidden md:hidden pb-4 space-y-2">
                <a href="mentor_dashboard.php" class="block py-2 px-4 text-gray-600 hover:bg-gray-100 rounded-lg">Dashboard</a>
                <a href="mentor_messages.php" class="block py-2 px-4 bg-purple-50 text-purple-700 rounded-lg">Inbox</a>
